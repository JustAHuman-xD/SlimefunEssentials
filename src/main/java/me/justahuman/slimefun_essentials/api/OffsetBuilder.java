...
public class OffsetBuilder {
    ...
    public OffsetBuilder(RecipeRenderer recipeRenderer, SlimefunRecipe slimefunRecipe, int x, int y, int minY) {
        this.labelOffset = recipeRenderer.calculateYOffset(slimefunRecipe, TextureUtils.labelSize) + minY;
        this.energyOffset = recipeRenderer.calculateYOffset(slimefunRecipe, TextureUtils.energyHeight) + minY;
    ...
    public static class Offset {
        ...
        public void addLabel(boolean padding) {
            this.value += TextureUtils.labelSize + (padding ? TextureUtils.padding : 0);
        }
        ...
        public void addEnergy(boolean padding) {
            this.value += TextureUtils.energyWidth + (padding ? TextureUtils.padding : 0);
        }
        ...
        public void addSlot(boolean padding) {
            this.value += TextureUtils.slotSize + (padding ? TextureUtils.padding : 0);
        }
        ...
        public void addArrow(boolean padding) {
            this.value += TextureUtils.arrowWidth + (padding ? TextureUtils.padding : 0);
        }
        ...
        public void addOutput(boolean padding) {
            this.value += TextureUtils.outputSize + (padding ? TextureUtils.padding : 0);
        }
